...
class ListPublicationsAdapter(private val listener: OnPublicationClickListener) : RecyclerView.Adapter<ListPublicationsAdapter.ListPublicationViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ListPublicationViewHolder, position: Int) {
        holder.binding.apply {
            ...
            institutionImage.setOnClickListener {
                listener.onPublicationClick(publication)
            }
